...
function initLight() {
  light1 = new THREE.DirectionalLight(0xffffff, 0.9);//ánh sáng 1 là ánh sáng để tạo bóng với màu là oxfffff với cường độ sáng là 0.9
  light1.position.set(1, 1, 0.5);// vị trí đặt  ánh sáng set chiều rộng chiều cao chiều sâu
  scene.add(light1);// them ánh sáng 1 vào bối cảnh
  light2 = new THREE.HemisphereLight(0xaaaaaa, 0x000000, 0.9);//Nguồn sáng đặt ngay phía trên vật, với màu sắc nhạt dần từ màu thuộc tinhs 1  đến màu thuoc tính 2.

  scene.add(light2);// them ánh sáng vào bối cảnh
}
